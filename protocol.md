# BitTorrent Protocol
Our peer to peer file transfer system will be based off of the BitTorrent Protocol BTP/1.0. We have used [this document](http://jonas.nitro.dk/bittorrent/bittorrent-rfc.html) to provide us with the standards of BTP/1.0.
